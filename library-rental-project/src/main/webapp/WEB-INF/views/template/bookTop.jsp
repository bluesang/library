...
<nav class="w3-sidenav w3-collapse w3-theme-l5 w3-animate-left" style="z-index:3;width:250px;margin-top:51px;" id="mySidenav">
  ...
  <h4><b>Menu</b></h4>
  <a href="<%=request.getContextPath() %>/book/bookRegister.jsp" class="w3-hover-black">도서등록</a>
  <a href="<%=request.getContextPath() %>/book/bookDisposal.jsp" class="w3-hover-black">도서폐기등록</a>
</nav>
